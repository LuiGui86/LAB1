...
descuento es $ 500 entonces el porcentaje de descuento aplicado fue el 0%.*/
 ...
 int main () {
    float impVenta, impVentadesc, totalDesc;
    cout<<"Importe de venta:" <<endl;
    cin>>impVenta;
    cout<<"Importe de la venta con descuento aplicado:" <<endl;
    cin>>impVentadesc;

    totalDesc=(impVentadesc*100)/impVenta;
    cout<<"El porcentaje de descuento es del:" <<totalDesc;
